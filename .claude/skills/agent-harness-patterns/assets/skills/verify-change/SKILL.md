---
name: verify-change
description: Run a repo-appropriate verification pass before reporting non-trivial work complete, especially after multi-file edits, backend changes, or infrastructure changes.
---
...
2. Run the checks in increasing cost order.
...
- search for package-manager scripts, CI config, make targets, or test directories
- choose the lightest relevant command
- if nothing is available, state that verification is limited and why
